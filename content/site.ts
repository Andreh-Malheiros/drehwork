...
const projectCover = (name: string, src: string, width: number, height: number): MediaItem[] => [
  { type: "cover", src, alt: `Imagem de capa do projeto ${name}`, width, height },
];

export const projects: Project[] = [
  { slug: "bh-carimbos", name: "BH Carimbos", url: "https://bhcarimbos.com.br/", category: "Site institucional e presença local", createdByDrehWork: true, status: "Concluído", scope: ["Estratégia", "Arquitetura das páginas", "Design", "Desenvolvimento", "Responsividade", "Integrações", "Publicação", "Presença local", "Estrutura para busca"], media: projectCover("BH Carimbos", "/images/bhcarimbos.png", 1905, 1811), pendingCaseStudy: true },
  { slug: "amftv", name: "AMFTV", url: "https://amftv.com.br/", category: "Site institucional", createdByDrehWork: true, status: "Concluído", scope: ["Estratégia", "Arquitetura", "Design", "Desenvolvimento", "Responsividade", "Publicação"], media: projectCover("AMFTV", "/images/amftv.png", 1905, 905), pendingCaseStudy: true },
  { slug: "wayne-store", name: "Wayne Store", url: "https://usewayne.com.br/", category: "Comércio eletrônico", createdByDrehWork: true, status: "Concluído", scope: ["Criação", "Desenvolvimento", "Configuração da loja", "Personalização", "Estrutura visual", "Experiência de navegação"], media: projectCover("Wayne Store", "/images/usewayne.png", 1910, 1773), pendingCaseStudy: true },
  { slug: "noar-oficial", name: "NOAR Oficial", url: "https://noaroficial.com.br/", category: "Comércio eletrônico e moda", createdByDrehWork: true, status: "Concluído", scope: ["Criação", "Desenvolvimento", "Configuração da loja", "Personalização", "Direção visual", "Experiência de navegação"], media: projectCover("NOAR Oficial", "/images/noaroficial.png", 1905, 1922), pendingCaseStudy: true },
  { slug: "ammis-moda", name: "Ammis Moda", url: "https://ammismoda.com.br/", category: "Evolução contínua em Shopify", createdByDrehWork: false, status: "Atuação recorrente", scope: ["Manutenção mensal", "Personalização", "Correções", "Melhorias de interface", "Evolução da experiência", "Modificações Shopify", "Suporte técnico"], media: projectCover("Ammis Moda", "/images/ammismoda.png", 1905, 2550), pendingCaseStudy: true },
];
