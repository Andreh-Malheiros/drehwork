...
export function GLSLHills({ width = "100vw", height = "100vh", cameraZ = 125, planeSize = 256, speed = 0.5 }: GLSLHillsProps) {
  ...
  return (
    <div ref={containerRef} className="glsl-hills" style={{ width, height }}>
