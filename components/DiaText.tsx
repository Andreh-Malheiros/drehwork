...
const componentThemeClassName =
  "[--ic-foreground:#111111] dark:[--ic-foreground:#f6f3ec]";
  ...
  (
    ...
    return (
      <motion.span
        ...
        className={cn(componentThemeClassName, "dia-text", className)}
        ref={setRefs}
        style={containerStyle}
        transition={{ duration: 0.4, ease: [0.4, 0, 0.2, 1] }}
        {...props}
      >
        <motion.span aria-hidden className="dia-text-content" style={contentStyle}>
          {texts[activeIndex]}
        </motion.span>
